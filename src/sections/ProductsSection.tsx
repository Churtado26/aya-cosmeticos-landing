...
const nikolsImages = [
    ...
    "/assets/nikols/CATALOGO VITAL BELL_page-0018.jpg",
    "/assets/nikols/CATALOGO VITAL BELL_page-0020.jpg",
    "/assets/nikols/CATALOGO VITAL BELL_page-0023.jpg",
    "/assets/nikols/CATALOGO VITAL BELL_page-0024.jpg",
    "/assets/nikols/CATALOGO VITAL BELL_page-0025.jpg",
    "/assets/nikols/CATALOGO VITAL BELL_page-0026.jpg",
    "/assets/nikols/CATALOGO VITAL BELL_page-0029.jpg",
    "/assets/nikols/CATALOGO VITAL BELL_page-0033.jpg",
    "/assets/nikols/CATALOGO VITAL BELL_page-0034.jpg",
];
...
const belierImages = [
    ...
    "/assets/belier/catalogo DIGITAL comercial BELIERIMG_compressed_page-0025.jpg",
    "/assets/belier/catalogo DIGITAL comercial BELIERIMG_compressed_page-0030.jpg",
];

const mykImages = [
    "/assets/myk/image-myk-1.png",
    "/assets/myk/image-myk-2.png",
    "/assets/myk/image-myk-3.png",
    "/assets/myk/image-myk-4.png",
    "/assets/myk/image-myk-5.png",
    "/assets/myk/image-myk-6.png",
    "/assets/myk/image-myk-7.png",
    "/assets/myk/image-myk-8.png",
    "/assets/myk/image-myk-9.png",
    "/assets/myk/image-myk-10.png",
    "/assets/myk/image-myk-11.png",
    "/assets/myk/image-myk-12.png",
    "/assets/myk/image-myk-13.png",
];
    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                viewport={{ once: true }}
            >
                <h2 className="text-5xl font-medium text-whitemove-gradient px-3 rounded-xl italic font-semibold bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-violet-500 to-indigo-500">
                    Nuestras marcas
                </h2>
            ...
            >
                ...
                <p className="gray-color-text mt-2 max-w-xl text-base">
                    Productos de maquillaje de alta calidad para resaltar la belleza única de cada persona.
                </p>

                <ImageCarousel images={mykImages} />

                <a
                    href="/assets/myk/catalogo-myk.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 mt-8 main-bg-color text-white rounded-full px-6 py-3 transition"
                >
